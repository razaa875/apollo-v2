        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-y-8">
            <div className="lg:w-[30%] xl:w-[35%]">
                ...
                <div className="mt-4 flex-col gap-y-4 hidden lg:flex">
                    <p className={`w-fit cursor-pointer text-base pl-4 transition-all ease border-l-2 ${activeItem === "item-1" ? 'border-black text-black font-medium' : 'text-primary/60 border-transparent font-normal'}`} onClick={() => setActiveItem("item-1")}>Who IS Incharge</p>
                    <p className={`w-fit cursor-pointer text-base pl-4 transition-all  ease border-l-2 ${activeItem === "item-2" ? 'border-black text-black font-medium' : 'text-primary/60 border-transparent font-normal'}`} onClick={() => setActiveItem("item-2")}>Company History</p>
                </div>
            </div>
            <div className="lg:w-[60%] xl:w-[50%]">
                ...
                >
                    <AccordionItem value="item-1">
                        <AccordionTrigger>Who IS Incharge</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2">
                        <AccordionTrigger>Company History</AccordionTrigger>
                        <AccordionContent className="text-balance flex flex-col gap-y-4">
                            <p className="text-sm lg:text-base font-normal">
                                Tesla makes money by selling electric vehicles, battery energy storage
                                systems, solar panels, and solar roof tiles, along with related products and services.
