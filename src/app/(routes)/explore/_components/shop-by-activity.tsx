...
export default function ShopByActivity() {
    ...
    return (
        <>
            <h2 className="w-[90%] mx-auto text-center text-4xl lg:text-6xl font-medium">Shop by Activity</h2>
                                        ...
                                        {activeData.map((person, i) => (
                                            <div key={i} className="rounded-2xl overflow-hidden">
                                                <Image
                                                    ...
                                                    width={400}
                                                    height={300}
                                                    className="w-full h-50 object-cover rounded-2xl drop-shadow-2xl hover:scale-[1.02] transition-transform duration-300"
                                                />
                                            </div>
                                        ))}
                                    </div>
