...
export default function JournalsGuides() {
  ...
  return (
    <>
      <h2 className="w-[90%] mx-auto text-center text-4xl lg:text-6xl font-medium mt-40">
        Journals/Guides
      </h2>
            ...
            >
              <Card className="w-full border-none shadow-none bg-transparent pt-0 gap-5 cursor-pointer">
                ...
                <CardFooter className="flex-col gap-2 items-start px-0">
                  ...
                  <p className="text-start text-xl font-medium">{item.title}</p>
                </CardFooter>
              </Card>
            </CarouselItem>
          ))}
