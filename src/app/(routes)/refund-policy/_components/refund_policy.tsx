    ...
    <div className="w-[90%] mx-auto">
      ...
      <div className="md:space-y-6 text-sm md:text-base font-normal">
        <p>
          ...
          All access and use of the service is subject to the Privacy Policy contained in these Terms of Service (as amended from time to time, these &quot;Terms of Service&quot; or &quot;Terms&quot;).
          ...
          If you do not accept the Privacy Policy of these Terms of Service, you may not access, browse, or otherwise use the service.
        </p>
