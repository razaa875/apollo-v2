  ...
  return (
    <section className="bg-[url(/images/brand-profile/hero.webp)] bg-no-repeat bg-cover min-h-screen flex items-center justify-center relative">
      ...
      <div className="w-[90%] mx-auto flex flex-col relative z-1">
        <h1 className="font-medium text-3xl xl:text-6xl text-white lg:w-[60%] xl:w-[80%]">
          Lorem ipsum dolor sit amet consectetur.
        </h1>
        <p className="font-normal text-base xl:text-lg text-white/80 lg:w-[60%] xl:w-[90%] 2xl:w-[70%] mt-2">
        ...
        <Button
          variant="outline"
          fullWidth
          className="bg-background/20 backdrop-blur-xs mt-6 border-white text-white md:w-[50%] xl:w-[25%]"
        >
          Shop Now <ArrowRight />
        </Button>
      </div>
